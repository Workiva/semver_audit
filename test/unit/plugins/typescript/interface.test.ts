...
import { InterfaceGrammar, TypeAliasGrammar } from '../../../../src/plugins/typescript/typescript_grammar';
...
test('removing a member from an object type is a major', () => 
  expect(
    semverInterfaceDiff({
      base: { members: { a: { required: true, readonly: false, type: 'string' }  } },
      target: { members: {} },
    }),
...
test('adding a optional member to an object type is a minor', () =>
  expect(
    semverInterfaceDiff({
      base: { members: { } },
      target: { members: { a: { required: false, readonly: false, type: 'string' } } },
    }),
...
test('adding a required member to an object type is a major', () => 
   expect(
    semverInterfaceDiff({
      base: { members: { } },
      target: { members: { a: { required: true, readonly: false, type: 'string' } } },
    }),
...
test('changing the type of a member in an object type is a major', () => 
   expect(
    semverInterfaceDiff({
      base: { members: { a: { required: false, readonly: false, type: 'number' } } },
      target: { members: { a: { required: false, readonly: false, type: 'string' } } },
    }),
  ).toEqual([Semver.major(`Changing the member type of 'a' is a major`)]));

test('making a member optional is a minor', () => expect(
    semverInterfaceDiff({
      base: { members: { a: { required: true, readonly: false, type: 'number' } } },
      target: { members: { a: { required: false, readonly: false, type: 'number' } } },
    }),
  ).toEqual([Semver.minor(`Making the member 'a' optional is a minor`)]));

test('removing optional from a member is a major', () => expect(
    semverInterfaceDiff({
      base: { members: { a: { required: false, readonly: false, type: 'number' } } },
      target: { members: { a: { required: true, readonly: false, type: 'number' } } },
    }),
