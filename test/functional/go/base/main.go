...
func AnotherFunction(param1 string, param2 int) (string, error) {
...
type AJsonSerializableStruct struct {
	...
	ChangedNameField string `json:"CHANGED,omitempty"`
	OmitEmptyAddedField string `json:"omitEmptyAdded"`
	OmitEmptyRemovedField string `json:"omitEmptyRemoved,omitempty"`
}